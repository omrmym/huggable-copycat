...
import { useIncomeCategories, useCreateIncomeCategory, useUpdateIncomeCategory, useDeleteIncomeCategory, IncomeCategory } from '@/hooks/useIncomeCategories';

export function IncomeCategoryManagement() {
    ...
    <Card className="bg-card border-border">
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>
            Manage income categories for tracking purposes.
          </CardDescription>
        </div>
      ...
      <CardContent>
        {isLoading ? (
          ...
          <p className="text-muted-foreground text-center py-8">No categories found. Add your first category!</p>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
