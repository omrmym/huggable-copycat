...
export const PERMISSION_DEFINITIONS = {
  ...
  menu: {
    label: 'Menu & Sub-Menu Visibility',
    icon: LayoutDashboard,
    subcategories: {
      main_menus: {
        label: 'Main Menus',
        permissions: [
          ...
          { key: 'menu.hr_admin', label: 'HR Admin' },
          { key: 'menu.users', label: 'My Users' },
          { key: 'menu.recharge', label: 'Recharge' },
          { key: 'menu.finance', label: 'Finance' },
          { key: 'menu.reports', label: 'Reports' },
          { key: 'menu.plans', label: 'Plans' },
          { key: 'menu.sms', label: 'SMS History' },
          { key: 'menu.activity', label: 'Activity' },
          { key: 'menu.settings', label: 'Settings' },
        ],
      },
      users_submenu: {
        label: 'My Users Sub-Menus',
        permissions: [
          { key: 'menu.users.create_user', label: 'Create User' },
          { key: 'menu.users.all_users', label: 'All Users' },
          { key: 'menu.users.requests', label: 'Requests' },
          { key: 'menu.users.area', label: 'Area' },
          { key: 'menu.users.police_station', label: 'Police Station' },
          { key: 'menu.users.district', label: 'District' },
        ],
      },
      recharge_submenu: {
        label: 'Recharge Sub-Menus',
        permissions: [
          { key: 'menu.recharge.statistics', label: 'Billing Statistics' },
          { key: 'menu.recharge.customer', label: 'Customer Recharge' },
          { key: 'menu.recharge.manage', label: 'Manage Recharge' },
          { key: 'menu.recharge.pending', label: 'Pending Bill Collection' },
          { key: 'menu.recharge.approved', label: 'Approved Bill Collection' },
        ],
      },
      finance_submenu: {
        label: 'Finance Sub-Menus',
        permissions: [
          { key: 'menu.finance.overview', label: 'Overview' },
          { key: 'menu.finance.income', label: 'Income' },
          { key: 'menu.finance.expense', label: 'Expense' },
        ],
      },
      reports_submenu: {
        label: 'Reports Sub-Menus',
        permissions: [
          { key: 'menu.reports.billing', label: 'Billing Report' },
          { key: 'menu.reports.connection_fee', label: 'Connection Fee' },
          { key: 'menu.reports.extra_income', label: 'Extra Income' },
          { key: 'menu.reports.expense', label: 'Expense' },
          { key: 'menu.reports.employee_salary', label: 'Employee Salary' },
          { key: 'menu.reports.leave', label: 'Leave Report' },
          { key: 'menu.reports.final', label: 'Final Report' },
          { key: 'menu.reports.manwise', label: 'Man Wise Bill Collection' },
          { key: 'menu.reports.new_line', label: 'Monthly New Line' },
          { key: 'menu.reports.expire', label: 'Monthly Expire User' },
          { key: 'menu.reports.btrc', label: 'BTRC Report' },
        ],
      },
    },
    permissions: [],
