...
export const ROUTE_PERMISSIONS: Record<string, string[]> = {
  ...
  '/users/area': [],
  '/users/police-station': [],
  '/users/district': [],
  '/users/requests': ['users.requests.view'],
  '/users/online-offline': ['users.online_offline.view'],
  '/recharge/statistics': ['sub.recharge.statistics', 'recharge.statistics'],
  '/recharge/customer': ['sub.recharge.customer', 'recharge.customer', 'recharge.customer.recharge'],
  '/recharge/manage': ['sub.recharge.manage', 'recharge.manage', 'recharge.manage.delete', 'recharge.manage.invoice'],
  '/recharge/pending': ['sub.recharge.pending', 'recharge.pending', 'recharge.pending.approve', 'recharge.pending.reject'],
  '/recharge/approved': ['sub.recharge.approved', 'recharge.approved', 'recharge.approved.delete', 'recharge.approved.invoice'],
  '/plans': ['plans.view'],
  ...
  '/sms-history': ['sms.send', 'sms.group_send', 'sms.history', 'sms.templates'],
